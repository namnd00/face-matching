...
def generate_data():
    ...
    sub_path = "../../datasets/pre_data/face.evoLVe.PyTorch/backbone_ir50_asia"
...
def my_process(file_name):
    emb_path = f"../../datasets/pre_data/face.evoLVe.PyTorch/backbone_ir50_asia/{file_name}"
...
def my_process_train_augmentation(file_name):
    emb_path = f"../../datasets/pre_data/face.evoLVe.PyTorch/backbone_ir50_asia/{file_name.replace('.npy', '_aug.npy')}"
...
def prepare_dataset():
    ...
    shutil.rmtree(f"../../datasets/pre_data/face.evoLVe.PyTorch/backbone_ir50_asia")
