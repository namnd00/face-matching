...
def generate_data():
    ...
    sub_path = "../../datasets/pre_data/Dynamic_multi-task-learning/20180115-025629_model"
...
def my_process(file_name):
    emb_path = f"../../datasets/pre_data/Dynamic_multi-task-learning/20180115-025629_model/{file_name}"
...
def my_process_train_augmentation(file_name):
    emb_path = f"../../datasets/pre_data/Dynamic_multi-task-learning/20180115-025629_model/{file_name.replace('.npy', '_aug.npy')}"
...
def prepare_dataset():
    ...
    shutil.rmtree(f"../../datasets/pre_data/facenet/20180402-114759")
