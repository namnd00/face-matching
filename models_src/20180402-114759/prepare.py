...
def generate_data():
    ...
    sub_path = "../../datasets/pre_data/facenet/20180402-114759"
...
def my_process(file_name):
    emb_path = f"../../datasets/pre_data/facenet/20180402-114759/{file_name}"
...
def my_process_train_augmentation(file_name):
    emb_path = f"../../datasets/pre_data/facenet/20180402-114759/{file_name.replace('.npy', '_aug.npy')}"
