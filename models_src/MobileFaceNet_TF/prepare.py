...
IMPORT_DIRECTORY = "../../datasets/pre_data/MobileFaceNet/MobileFaceNet_TF"
...
def my_process(file_name):
    emb_path = os.path.join(IMPORT_DIRECTORY, file_name)
...
def my_process_train_augmentation(file_name):
    emb_path = os.path.join(IMPORT_DIRECTORY, file_name.replace('.npy', '_aug.npy'))
